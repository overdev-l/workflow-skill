...
export const translations = {
  'zh-CN': {
    ...
    skills: {
      ...
      safeDeleteConfirmTitle: '彻底删除 Skill 资产',
      safeDeleteConfirmDesc: (name: string, count: number) => `确定要彻底删除 “${name}” 吗？系统将自动安全清理 ${count} 个 AI 工具目录中的软链接，并移除中央源文件。`,
      safeDeleteLinkedNotice: '将联动解除以下工具中的软链接：',
      confirmDeleteBtn: '彻底删除',
  ...
  'en-US': {
    ...
    skills: {
      ...
      safeDeleteConfirmTitle: 'Permanently Delete Skill Asset',
      safeDeleteConfirmDesc: (name: string, count: number) => `Are you sure you want to permanently delete “${name}”? The system will safely remove symlinks in ${count} AI tool directories and remove central files.`,
      safeDeleteLinkedNotice: 'Will safely remove symlinks from the following tools:',
