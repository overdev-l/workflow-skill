...
export const translations = {
  'zh-CN': {
    ...
    environments: {
      title: 'AI 环境生态',
      subtitle: '统一管理各 AI 编程 Agent 与 IDE 的技能分发与符号链接目录',
      tabEnvironments: 'AI 环境',
      rescanBtn: '重新扫描已装环境',
      syncAllToTargetBtn: '一键挂载全部 Skill',
      unlinkAllFromTargetBtn: '清空此环境软链接',
      openDirBtn: '在文件管理器中打开技能目录',
      mountedSkillsLabel: (count: number) => `${count} 个 Skill 已挂载`,
      noMountedSkills: '暂无 Skill 挂载到此环境',
      installedReady: '已安装环境就绪',
      notDetected: '未检测到环境目录',
      categoryIde: 'AI 独立编辑器',
      categoryCli: '终端 / CLI 智能体',
      categoryExtension: '编辑器插件 Agent',
      categoryStandard: '开放标准规范',
      metricSupported: '支持的 AI 环境',
      metricInstalled: '本机就绪环境',
  ...
  'en-US': {
    ...
    environments: {
      title: 'AI Environments & Ecosystem',
      subtitle: 'Unified skill distribution and symlink management across coding agents and IDEs',
      tabEnvironments: 'AI Environments',
      rescanBtn: 'Re-scan Environments',
      syncAllToTargetBtn: 'Mount All Skills',
      unlinkAllFromTargetBtn: 'Unlink All Skills',
      openDirBtn: 'Open Skills Directory',
      mountedSkillsLabel: (count: number) => `${count} skills mounted`,
      noMountedSkills: 'No skills mounted to this environment yet',
      installedReady: 'Installed & Ready',
      notDetected: 'Directory not detected',
      categoryIde: 'AI IDEs',
      categoryCli: 'CLI Agents',
      categoryExtension: 'Extensions',
      categoryStandard: 'Open Standards',
      metricSupported: 'Supported Environments',
      metricInstalled: 'Local Ready Environments',
